...
gcc --mode toolchain --target toolchain --strip no --jobs 1 --ignore-dependencies --skip-preinstall
...
gcc --mode toolchain --host toolchain --strip no --jobs 1 --ignore-dependencies --skip-preinstall --force
